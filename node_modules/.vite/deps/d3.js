...
define_default(Cubehelix, cubehelix, extend(Color, {
  ...
  rgb: function() {
    var h = isNaN(this.h) ? 0 : (this.h + 120) * deg2rad, l = +this.l, a4 = isNaN(this.s) ? 0 : this.s * l * (1 - l), cosh3 = Math.cos(h), sinh3 = Math.sin(h);
    return new Rgb(
...
function basis(t16, v0, v1, v2, v3) {
  var t23 = t16 * t16, t33 = t23 * t16;
  return ((1 - 3 * t16 + 3 * t23 - t33) * v0 + (4 - 6 * t23 + 3 * t33) * v1 + (1 + 3 * t16 + 3 * t23 - 3 * t33) * v2 + t33 * v3) / 6;
}
...
function decompose_default(a4, b, c6, d, e, f) {
  ...
  return {
    translateX: e,
    translateY: f,
    rotate: Math.atan2(b, a4) * degrees,
...
function hsl2(hue3) {
  return function(start2, end) {
    var h = hue3((start2 = hsl(start2)).h, (end = hsl(end)).h), s2 = nogamma(start2.s, end.s), l = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
    return function(t) {
      start2.h = h(t);
      start2.s = s2(t);
      start2.l = l(t);
...
function hcl2(hue3) {
  return function(start2, end) {
    var h = hue3((start2 = hcl(start2)).h, (end = hcl(end)).h), c6 = nogamma(start2.c, end.c), l = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
    return function(t) {
      start2.h = h(t);
      start2.c = c6(t);
      start2.l = l(t);
...
function nap() {
  var t06, t16 = taskHead, t23, time2 = Infinity;
  while (t16) {
    if (t16._call) {
      if (time2 > t16._time)
        time2 = t16._time;
      ...
      t23 = t16._next, t16._next = null;
      t16 = t06 ? t06._next = t23 : taskHead = t23;
    }
  }
  taskTail = t06;
  sleep(time2);
...
function attrTweenNS(fullname, value) {
  ...
  function tween() {
    ...
    if (i !== i0)
      t06 = (i0 = i) && attrInterpolateNS(fullname, i);
    return t06;
  }
  tween._value = value;
  return tween;
...
function attrTween(name, value) {
  ...
  function tween() {
    var i = value.apply(this, arguments);
    if (i !== i0)
      t06 = (i0 = i) && attrInterpolate(name, i);
    return t06;
  }
  tween._value = value;
  return tween;
...
function cubehelixConvert2(o) {
  ...
  if (!(o instanceof Rgb2))
    o = rgbConvert2(o);
  var r = o.r / 255, g = o.g / 255, b = o.b / 255, l = (BC_DA2 * b + ED2 * r - EB2 * g) / (BC_DA2 + ED2 - EB2), bl = b - l, k2 = (E2 * (g - l) - C2 * bl) / D2, s2 = Math.sqrt(k2 * k2 + bl * bl) / (E2 * l * (1 - l)), h = s2 ? Math.atan2(k2, bl) * degrees2 - 120 : NaN;
...
function contours_default() {
  ...
  function isorings(values, value, callback) {
    var fragmentByStart = new Array(), fragmentByEnd = new Array(), x4, y4, t06, t16, t23, t33;
    x4 = y4 = -1;
    t16 = above(values[0], value);
    cases[t16 << 1].forEach(stitch);
    while (++x4 < dx - 1) {
      t06 = t16, t16 = above(values[x4 + 1], value);
      cases[t06 | t16 << 1].forEach(stitch);
    }
    cases[t16 << 0].forEach(stitch);
    while (++y4 < dy - 1) {
      x4 = -1;
      t16 = above(values[y4 * dx + dx], value);
      t23 = above(values[y4 * dx], value);
      cases[t16 << 1 | t23 << 2].forEach(stitch);
      while (++x4 < dx - 1) {
        t06 = t16, t16 = above(values[y4 * dx + dx + x4 + 1], value);
        t33 = t23, t23 = above(values[y4 * dx + x4 + 1], value);
        cases[t06 | t16 << 1 | t23 << 2 | t33 << 3].forEach(stitch);
      }
      cases[t16 | t23 << 3].forEach(stitch);
    }
    x4 = -1;
...
function orient2dadapt(ax, ay, bx, by, cx, cy, detsum) {
  ...
  let bvirt, c6, ahi, alo, bhi, blo, _i, _j, _0, s1, s0, t16, t06, u32;
  const acx = ax - cx;
  const bcx = bx - cx;
  const acy = ay - cy;
  const bcy = by - cy;
  ...
  bhi = c6 - (c6 - bcx);
  blo = bcx - bhi;
  t06 = alo * blo - (t16 - ahi * bhi - alo * bhi - ahi * blo);
  _i = s0 - t06;
  bvirt = s0 - _i;
  B3[0] = s0 - (_i + bvirt) + (bvirt - t06);
  _j = s1 + _i;
  bvirt = _j - s1;
  _0 = s1 - (_j - bvirt) + (_i - bvirt);
  _i = _0 - t16;
  bvirt = _0 - _i;
  B3[1] = _0 - (_i + bvirt) + (bvirt - t16);
  u32 = _j + _i;
  bvirt = u32 - _j;
  ...
  _i = s0 - t06;
  bvirt = s0 - _i;
  u[0] = s0 - (_i + bvirt) + (bvirt - t06);
  _j = s1 + _i;
  bvirt = _j - s1;
  _0 = s1 - (_j - bvirt) + (_i - bvirt);
  _i = _0 - t16;
  bvirt = _0 - _i;
  u[1] = _0 - (_i + bvirt) + (bvirt - t16);
  u32 = _j + _i;
  bvirt = u32 - _j;
...
var Voronoi = class {
  ...
  _init() {
    ...
    for (let i = 0, j = 0, n = triangles.length, x4, y4; i < n; i += 3, j += 2) {
      const t16 = triangles[i] * 2;
      const t23 = triangles[i + 1] * 2;
      const t33 = triangles[i + 2] * 2;
      const x13 = points[t16];
      const y13 = points[t16 + 1];
...
var Delaunay = class _Delaunay {
  ...
  *neighbors(i) {
  ...
  renderTriangle(i, context) {
    ...
    const t06 = triangles[i *= 3] * 2;
    const t16 = triangles[i + 1] * 2;
...
function nap2() {
  var t06, t16 = taskHead2, t23, time2 = Infinity;
  while (t16) {
    if (t16._call) {
      if (time2 > t16._time)
        time2 = t16._time;
      ...
      t23 = t16._next, t16._next = null;
      t16 = t06 ? t06._next = t23 : taskHead2 = t23;
    }
  }
  taskTail2 = t06;
  sleep2(time2);
...
function locale_default(locale4) {
  var group5 = locale4.grouping === void 0 || locale4.thousands === void 0 ? identity_default2 : formatGroup_default(map5.call(locale4.grouping, Number), locale4.thousands + ""), currencyPrefix = locale4.currency === void 0 ? "" : locale4.currency[0] + "", currencySuffix = locale4.currency === void 0 ? "" : locale4.currency[1] + "", decimal = locale4.decimal === void 0 ? "." : locale4.decimal + "", numerals = locale4.numerals === void 0 ? identity_default2 : formatNumerals_default(map5.call(locale4.numerals, String)), percent = locale4.percent === void 0 ? "%" : locale4.percent + "", minus = locale4.minus === void 0 ? "−" : locale4.minus + "", nan = locale4.nan === void 0 ? "NaN" : locale4.nan + "";
  function newFormat(specifier) {
    specifier = formatSpecifier(specifier);
    var fill = specifier.fill, align = specifier.align, sign3 = specifier.sign, symbol = specifier.symbol, zero7 = specifier.zero, width = specifier.width, comma = specifier.comma, precision = specifier.precision, trim = specifier.trim, type2 = specifier.type;
    if (type2 === "n")
      comma = true, type2 = "g";
    else if (!formatTypes_default[type2])
      precision === void 0 && (precision = 12), trim = true, type2 = "g";
    if (zero7 || fill === "0" && align === "=")
      zero7 = true, fill = "0", align = "=";
...
function circleStream(stream, radius, delta, direction, t06, t16) {
  ...
  if (t06 == null) {
    ...
    if (direction > 0 ? t06 < t16 : t06 > t16)
      t06 += direction * tau5;
  }
...
function line_default(a4, b, x06, y06, x12, y12) {
  var ax = a4[0], ay = a4[1], bx = b[0], by = b[1], t06 = 0, t16 = 1, dx = bx - ax, dy = by - ay, r;
  r = x06 - ax;
  if (!dx && r > 0)
    return;
  r /= dx;
  ...
  if (t06 > 0)
    a4[0] = ax + t06 * dx, a4[1] = ay + t06 * dy;
  if (t16 < 1)
    b[0] = ax + t16 * dx, b[1] = ay + t16 * dy;
  return true;
}
...
function graticuleX(y06, y12, dy) {
  var y4 = range4(y06, y12 - epsilon7, dy).concat(y12);
  return function(x4) {
...
function graticuleY(x06, x12, dx) {
  var x4 = range4(x06, x12 - epsilon7, dx).concat(x12);
  return function(y4) {
...
function graticule() {
  ...
  function lines() {
    return range4(ceil(X03 / DX) * DX, X13, DX).map(X3).concat(range4(ceil(Y03 / DY) * DY, Y13, DY).map(Y3)).concat(range4(ceil(x06 / dx) * dx, x12, dx).filter(function(x5) {
      return abs3(x5 % DX) > epsilon7;
    }).map(x4)).concat(range4(ceil(y06 / dy) * dy, y12, dy).filter(function(y5) {
...
function hue2(a4, b) {
  var d = b - a4;
  return d ? linear3(a4, d > 180 || d < -180 ? d - 360 * Math.round(d / 360) : d) : constant_default10(isNaN(a4) ? b : a4);
}
function gamma2(y4) {
  return (y4 = +y4) === 1 ? nogamma2 : function(a4, b) {
    return b - a4 ? exponential2(a4, b, y4) : constant_default10(isNaN(a4) ? b : a4);
  };
}
function nogamma2(a4, b) {
  var d = b - a4;
  return d ? linear3(a4, d) : constant_default10(isNaN(a4) ? b : a4);
}
...
function string_default2(a4, b) {
  ...
  return s2.length < 2 ? q[0] ? one2(q[0].x) : zero5(b) : (b = q.length, function(t) {
    for (var i2 = 0, o; i2 < b; ++i2)
      s2[(o = q[i2]).i] = o.x(t);
    return s2.join("");
  });
...
function value_default2(a4, b) {
  var t = typeof b, c6;
  return b == null || t === "boolean" ? constant_default10(b) : (t === "number" ? number_default2 : t === "string" ? (c6 = color2(b)) ? (b = c6, rgb_default2) : string_default2 : b instanceof color2 ? rgb_default2 : b instanceof Date ? date_default2 : isNumberArray2(b) ? numberArray_default2 : Array.isArray(b) ? genericArray2 : typeof b.valueOf !== "function" && typeof b.toString !== "function" || isNaN(b) ? object_default2 : number_default2)(a4, b);
}
...
function decompose_default2(a4, b, c6, d, e, f) {
  ...
  return {
    translateX: e,
    translateY: f,
    rotate: Math.atan2(b, a4) * degrees4,
...
function parseCss2(value) {
  ...
  return m3.isIdentity ? identity5 : decompose_default2(m3.a, m3.b, m3.c, m3.d, m3.e, m3.f);
}
...
var zoom_default2 = function zoomRho(rho3, rho22, rho42) {
  function zoom(p02, p1) {
    ...
    if (d2 < epsilon23) {
      ...
      S = (r1 - r0) / rho3;
      i = function(t) {
        var s2 = t * S, coshr0 = cosh2(r0), u4 = w0 / (rho22 * d1) * (coshr0 * tanh2(rho3 * s2 + r0) - sinh2(r0));
        return [
          ux0 + u4 * dx,
          uy0 + u4 * dy,
...
function hsl4(hue3) {
  return function(start2, end) {
    var h = hue3((start2 = hsl3(start2)).h, (end = hsl3(end)).h), s2 = nogamma2(start2.s, end.s), l = nogamma2(start2.l, end.l), opacity = nogamma2(start2.opacity, end.opacity);
    return function(t) {
      start2.h = h(t);
      start2.s = s2(t);
      start2.l = l(t);
...
function lab4(start2, end) {
  var l = nogamma2((start2 = lab3(start2)).l, (end = lab3(end)).l), a4 = nogamma2(start2.a, end.a), b = nogamma2(start2.b, end.b), opacity = nogamma2(start2.opacity, end.opacity);
  return function(t) {
    start2.l = l(t);
    start2.a = a4(t);
    start2.b = b(t);
...
function hcl4(hue3) {
  return function(start2, end) {
    var h = hue3((start2 = hcl3(start2)).h, (end = hcl3(end)).h), c6 = nogamma2(start2.c, end.c), l = nogamma2(start2.l, end.l), opacity = nogamma2(start2.opacity, end.opacity);
    return function(t) {
      start2.h = h(t);
      start2.c = c6(t);
      start2.l = l(t);
...
function cubehelix4(hue3) {
  return function cubehelixGamma(y4) {
    y4 = +y4;
    function cubehelix5(start2, end) {
      var h = hue3((start2 = cubehelix3(start2)).h, (end = cubehelix3(end)).h), s2 = nogamma2(start2.s, end.s), l = nogamma2(start2.l, end.l), opacity = nogamma2(start2.opacity, end.opacity);
      return function(t) {
        start2.h = h(t);
        start2.s = s2(t);
        start2.l = l(Math.pow(t, y4));
...
function bisector4(f) {
  ...
  if (f.length !== 2) {
    ...
    compare1 = f === ascending5 || f === descending4 ? f : zero6;
    compare2 = f;
    delta = f;
  }
  function left2(a4, x4, lo = 0, hi = a4.length) {
...
function* numbers4(values, valueof) {
  if (valueof === void 0) {
    for (let value of values) {
      if (value != null && (value = +value) >= value) {
        yield value;
...
function compareDefined4(compare = ascending5) {
  if (compare === ascending5)
    return ascendingDefined4;
  if (typeof compare !== "function")
    throw new TypeError("compare is not a function");
  return (a4, b) => {
    const x4 = compare(a4, b);
...
function ascendingDefined4(a4, b) {
  return (a4 == null || !(a4 >= a4)) - (b == null || !(b >= b)) || (a4 < b ? -1 : a4 > b ? 1 : 0);
}
...
function ticks4(start2, stop, count6) {
  stop = +stop, start2 = +start2, count6 = +count6;
  if (!(count6 > 0))
    return [];
  if (start2 === stop)
...
function quickselect4(array7, k2, left2 = 0, right2 = Infinity, compare) {
  k2 = Math.floor(k2);
  left2 = Math.floor(Math.max(0, left2));
  right2 = Math.floor(Math.min(array7.length - 1, right2));
  if (!(left2 <= k2 && k2 <= right2))
    return array7;
  compare = compare === void 0 ? ascendingDefined4 : compareDefined4(compare);
  while (right2 > left2) {
    if (right2 - left2 > 600) {
      const n = right2 - left2 + 1;
      const m3 = k2 - left2 + 1;
      ...
      const newLeft = Math.max(left2, Math.floor(k2 - m3 * s2 / n + sd));
      const newRight = Math.min(right2, Math.floor(k2 + (n - m3) * s2 / n + sd));
      quickselect4(array7, k2, newLeft, newRight, compare);
    }
    const t = array7[k2];
    let i = left2;
    let j = right2;
...
function quantile4(values, p, valueof) {
  values = Float64Array.from(numbers4(values, valueof));
  if (!(n = values.length) || isNaN(p = +p))
    return;
  if (p <= 0 || n < 2)
    return min5(values);
  if (p >= 1)
    return max6(values);
  var n, i = (n - 1) * p, i0 = Math.floor(i), value0 = max6(quickselect4(values, i0).subarray(0, i0 + 1)), value1 = min5(values.subarray(i0 + 1));
  return value0 + (value1 - value0) * (i - i0);
}
function quantileSorted4(values, p, valueof = number5) {
  if (!(n = values.length) || isNaN(p = +p))
    return;
  if (p <= 0 || n < 2)
    return +valueof(values[0], 0, values);
...
function band() {
  ...
  function rescale() {
    ...
    var values = range6(n).map(function(i) {
...
function polymap(domain, range7, interpolate) {
  ...
  return function(x4) {
    var i2 = bisect_default4(domain, x4, 1, j) - 1;
    return r[i2](d[i2](x4));
  };
}
...
function transformer2() {
  var domain = unit, range7 = unit, interpolate = value_default, transform2, untransform, unknown, clamp = identity7, piecewise3, output, input;
  function rescale() {
  ...
  function scale2(x4) {
    return x4 == null || isNaN(x4 = +x4) ? unknown : (output || (output = piecewise3(domain.map(transform2), range7, interpolate)))(transform2(clamp(x4)));
  }
  scale2.invert = function(y4) {
    return clamp(untransform((input || (input = piecewise3(range7, domain.map(transform2), number_default)))(y4)));
  };
  scale2.domain = function(_) {
  ...
  scale2.clamp = function(_) {
    return arguments.length ? (clamp = _ ? true : identity7, rescale()) : clamp !== identity7;
  };
...
function continuous() {
  return transformer2()(identity7, identity7);
}

// node_modules/d3-scale/src/tickFormat.js
function tickFormat(start2, stop, count6, specifier) {
  var step = tickStep4(start2, stop, count6), precision;
...
function linearish(scale2) {
  ...
  scale2.ticks = function(count6) {
    var d = domain();
    return ticks4(d[0], d[d.length - 1], count6 == null ? 10 : count6);
  };
  ...
  scale2.nice = function(count6) {
    ...
    while (maxIter-- > 0) {
      step = tickIncrement4(start2, stop, count6);
      if (step === prestep) {
        d[i0] = start2;
        d[i1] = stop;
        return domain(d);
...
function identity8(domain) {
  ...
  scale2.domain = scale2.range = function(_) {
    return arguments.length ? (domain = Array.from(_, number6), scale2) : domain.slice();
  };
  scale2.unknown = function(_) {
    return arguments.length ? (unknown = _, scale2) : unknown;
  };
  scale2.copy = function() {
    return identity8(domain).unknown(unknown);
  };
...
function nice5(domain, interval3) {
  domain = domain.slice();
...
function loggish(transform2) {
  ...
  scale2.ticks = (count6) => {
    ...
    if (!(base % 1) && j - i < n) {
      ...
      z = ticks4(i, j, Math.min(j - i, n)).map(pows);
    }
...
function powish(transform2) {
  var scale2 = transform2(identity7, identity7), exponent2 = 1;
  function rescale() {
    return exponent2 === 1 ? transform2(identity7, identity7) : exponent2 === 0.5 ? transform2(transformSqrt, transformSquare) : transform2(transformPow(exponent2), transformPow(1 / exponent2));
  }
...
function radial() {
  ...
  scale2.range = function(_) {
    return arguments.length ? (squared.range((range7 = Array.from(_, number6)).map(square)), scale2) : range7.slice();
  };
  scale2.rangeRound = function(_) {
...
function quantile5() {
  ...
  function rescale() {
    ...
    while (++i < n)
      thresholds[i - 1] = quantileSorted4(domain, i / n);
    return scale2;
  }
  function scale2(x4) {
    return x4 == null || isNaN(x4 = +x4) ? unknown : range7[bisect_default4(thresholds, x4)];
  }
  ...
  scale2.copy = function() {
    return quantile5().domain(domain).range(range7).unknown(unknown);
  };
  return initRange.apply(scale2, arguments);
}
...
function quantize() {
  ...
  function scale2(x4) {
    return x4 != null && x4 <= x4 ? range7[bisect_default4(domain, x4, 0, n)] : unknown;
  }
  function rescale() {
    var i = -1;
    domain = new Array(n);
...
function ticker(year2, month2, week, day2, hour2, minute2) {
  ...
  function ticks5(start2, stop, count6) {
    ...
    const interval3 = count6 && typeof count6.range === "function" ? count6 : tickInterval(start2, stop, count6);
    const ticks6 = interval3 ? interval3.range(start2, +stop + 1) : [];
  ...
  function tickInterval(start2, stop, count6) {
    ...
    if (i === tickIntervals.length)
      return year2.every(tickStep4(start2 / durationYear, stop / durationYear, count6));
    if (i === 0)
...
function formatLookup(names) {
  var map10 = {}, i = -1, n = names.length;
  while (++i < n)
    map10[names[i].toLowerCase()] = i;
  return map10;
}
...
function calendar(ticks5, tickInterval, year2, month2, week, day2, hour2, minute2, second4, format2) {
  ...
  scale2.ticks = function(interval3) {
    var d = domain();
    return ticks5(d[0], d[d.length - 1], interval3 == null ? 10 : interval3);
  };
  scale2.tickFormat = function(count6, specifier) {
  ...
  scale2.nice = function(interval3) {
    ...
    return interval3 ? domain(nice5(d, interval3)) : scale2;
  };
  scale2.copy = function() {
    return copy(scale2, calendar(ticks5, tickInterval, year2, month2, week, day2, hour2, minute2, second4, format2));
  };
  return scale2;
}
function time() {
...
function transformer3() {
  var x06 = 0, x12 = 1, t06, t16, k10, transform2, interpolator = identity7, clamp = false, unknown;
  function scale2(x4) {
    return x4 == null || isNaN(x4 = +x4) ? unknown : interpolator(k10 === 0 ? 0.5 : (x4 = (transform2(x4) - t06) * k10, clamp ? Math.max(0, Math.min(1, x4)) : x4));
  }
  scale2.domain = function(_) {
    return arguments.length ? ([x06, x12] = _, t06 = transform2(x06 = +x06), t16 = transform2(x12 = +x12), k10 = t06 === t16 ? 0 : 1 / (t16 - t06), scale2) : [x06, x12];
  };
  scale2.clamp = function(_) {
...
function sequential() {
  var scale2 = linearish(transformer3()(identity7));
  scale2.copy = function() {
...
function sequentialQuantile() {
  var domain = [], interpolator = identity7;
  function scale2(x4) {
    if (x4 != null && !isNaN(x4 = +x4))
      return interpolator((bisect_default4(domain, x4, 1) - 1) / (domain.length - 1));
  }
  scale2.domain = function(_) {
    if (!arguments.length)
      return domain.slice();
  ...
  scale2.quantiles = function(n) {
    return Array.from({ length: n + 1 }, (_, i) => quantile4(domain, i / n));
  };
  scale2.copy = function() {
...
function transformer4() {
  var x06 = 0, x12 = 0.5, x22 = 1, s2 = 1, t06, t16, t23, k10, k21, interpolator = identity7, transform2, clamp = false, unknown;
  function scale2(x4) {
    return isNaN(x4 = +x4) ? unknown : (x4 = 0.5 + ((x4 = +transform2(x4)) - t16) * (s2 * x4 < s2 * t16 ? k10 : k21), interpolator(clamp ? Math.max(0, Math.min(1, x4)) : x4));
  }
  scale2.domain = function(_) {
    return arguments.length ? ([x06, x12, x22] = _, t06 = transform2(x06 = +x06), t16 = transform2(x12 = +x12), t23 = transform2(x22 = +x22), k10 = t06 === t16 ? 0 : 0.5 / (t16 - t06), k21 = t16 === t23 ? 0 : 0.5 / (t23 - t16), s2 = t16 < t06 ? -1 : 1, scale2) : [x06, x12, x22];
  };
  scale2.clamp = function(_) {
    return arguments.length ? (clamp = !!_, scale2) : clamp;
  };
  ...
  return function(t) {
    transform2 = t, t06 = t(x06), t16 = t(x12), t23 = t(x22), k10 = t06 === t16 ? 0 : 0.5 / (t16 - t06), k21 = t16 === t23 ? 0 : 0.5 / (t23 - t16), s2 = t16 < t06 ? -1 : 1;
    return scale2;
  };
}
function diverging() {
  var scale2 = linearish(transformer4()(identity7));
  scale2.copy = function() {
...
function cornerTangents(x06, y06, x12, y12, r1, rc, cw) {
  var x01 = x06 - x12, y01 = y06 - y12, lo = (cw ? rc : -rc) / sqrt3(x01 * x01 + y01 * y01), ox = lo * y01, oy = -lo * x01, x11 = x06 + ox, y11 = y06 + oy, x10 = x12 + ox, y10 = y12 + oy, x004 = (x11 + x10) / 2, y004 = (y11 + y10) / 2, dx = x10 - x11, dy = y10 - y11, d2 = dx * dx + dy * dy, r = r1 - rc, D4 = x11 * y10 - x10 * y11, d = (dy < 0 ? -1 : 1) * sqrt3(max7(0, r * r * d2 - D4 * D4)), cx0 = (D4 * dy - dx * d) / d2, cy0 = (-D4 * dx - dy * d) / d2, cx1 = (D4 * dy + dx * d) / d2, cy1 = (-D4 * dx + dy * d) / d2, dx0 = cx0 - x004, dy0 = cy0 - y004, dx1 = cx1 - x004, dy1 = cy1 - y004;
...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon9))
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da2, da1 = da2, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon9 && (padRadius ? +padRadius.apply(this, arguments) : sqrt3(r0 * r0 + r1 * r1)), rc = min6(abs4(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t06, t16;
      if (rp > epsilon9) {
      ...
      if (!(da1 > epsilon9))
        ...
        t06 = cornerTangents(x004, y004, x01, y01, r1, rc1, cw);
        t16 = cornerTangents(x11, y11, x10, y10, r1, rc1, cw);
        context.moveTo(t06.cx + t06.x01, t06.cy + t06.y01);
        if (rc1 < rc)
          context.arc(t06.cx, t06.cy, rc1, atan22(t06.y01, t06.x01), atan22(t16.y01, t16.x01), !cw);
        else {
          context.arc(t06.cx, t06.cy, rc1, atan22(t06.y01, t06.x01), atan22(t06.y11, t06.x11), !cw);
          context.arc(0, 0, r1, atan22(t06.cy + t06.y11, t06.cx + t06.x11), atan22(t16.cy + t16.y11, t16.cx + t16.x11), !cw);
          context.arc(t16.cx, t16.cy, rc1, atan22(t16.y11, t16.x11), atan22(t16.y01, t16.x01), !cw);
        }
      } else
      ...
      if (!(r0 > epsilon9) || !(da0 > epsilon9))
        ...
        t16 = cornerTangents(x01, y01, x004, y004, r0, -rc0, cw);
        context.lineTo(t06.cx + t06.x01, t06.cy + t06.y01);
        if (rc0 < rc)
          context.arc(t06.cx, t06.cy, rc0, atan22(t06.y01, t06.x01), atan22(t16.y01, t16.x01), !cw);
        else {
          context.arc(t06.cx, t06.cy, rc0, atan22(t06.y01, t06.x01), atan22(t06.y11, t06.x11), !cw);
          context.arc(0, 0, r0, atan22(t06.cy + t06.y11, t06.cx + t06.x11), atan22(t16.cy + t16.y11, t16.cx + t16.x11), cw);
          context.arc(t16.cx, t16.cy, rc0, atan22(t16.y11, t16.x11), atan22(t16.y01, t16.x01), !cw);
        }
      } else
...
function pie_default() {
  var value = identity_default5, sortValues = descending_default, sort5 = null, startAngle = constant_default11(0), endAngle = constant_default11(tau7), padAngle = constant_default11(0);
  function pie(data) {
    var i, n = (data = array_default4(data)).length, j, k2, sum7 = 0, index6 = new Array(n), arcs = new Array(n), a0 = +startAngle.apply(this, arguments), da2 = Math.min(tau7, Math.max(-tau7, endAngle.apply(this, arguments) - a0)), a1, p = Math.min(Math.abs(da2) / n, padAngle.apply(this, arguments)), pa = p * (da2 < 0 ? -1 : 1), v2;
    for (i = 0; i < n; ++i) {
...
function point5(that, t06, t16) {
  ...
  that._context.bezierCurveTo(x06 + dx, y06 + dx * t06, x12 - dx, y12 - dx * t16, x12, y12);
}
...
function timeInterval2(floori, offseti, count6, field) {
  function interval3(date2) {
    return floori(date2 = arguments.length === 0 ? /* @__PURE__ */ new Date() : /* @__PURE__ */ new Date(+date2)), date2;
  }
  interval3.floor = (date2) => {
  ...
  if (count6) {
    interval3.count = (start2, end) => {
      ...
      return Math.floor(count6(t05, t15));
    };
    interval3.every = (step) => {
      step = Math.floor(step);
      return !isFinite(step) || !(step > 0) ? null : !(step > 1) ? interval3 : interval3.filter(field ? (d) => field(d) % step === 0 : (d) => interval3.count(0, d) % step === 0);
...
function ticker2(year2, month2, week, day2, hour2, minute2) {
  ...
  function tickInterval(start2, stop, count6) {
    ...
    if (i === tickIntervals.length)
      return year2.every(tickStep(start2 / durationYear2, stop / durationYear2, count6));
    if (i === 0)
      return millisecond3.every(Math.max(tickStep(start2, stop, count6), 1));
    const [t, step] = tickIntervals[target / tickIntervals[i - 1][2] < tickIntervals[i][2] / target ? i - 1 : i];
    return t.every(step);
  }
  return [ticks5, tickInterval];
  ...
  function newFormat(specifier, formats2) {
    return function(date2) {
      ...
      while (++i < n) {
        if (specifier.charCodeAt(i) === 37) {
          string.push(specifier.slice(j, i));
          if ((pad4 = pads2[c6 = specifier.charAt(++i)]) != null)
            c6 = specifier.charAt(++i);
          else
            pad4 = c6 === "e" ? " " : "0";
          if (format2 = formats2[c6])
...
function zoom_default3() {
  ...
  zoom.scaleTo = function(selection2, k2, p, event) {
    zoom.transform(selection2, function() {
      var e = extent5.apply(this, arguments), t06 = this.__zoom, p02 = p == null ? centroid(e) : typeof p === "function" ? p.apply(this, arguments) : p, p1 = t06.invert(p02), k1 = typeof k2 === "function" ? k2.apply(this, arguments) : k2;
      return constrain(translate(scale2(t06, k1), p02, p1), e, translateExtent);
    }, p, event);
  };
  ...
  zoom.translateTo = function(selection2, x4, y4, p, event) {
    zoom.transform(selection2, function() {
      ...
      return constrain(identity9.translate(p02[0], p02[1]).scale(t.k).translate(
        typeof x4 === "function" ? -x4.apply(this, arguments) : -x4,
        typeof y4 === "function" ? -y4.apply(this, arguments) : -y4
      ), e, translateExtent);
    }, p, event);
  ...
  function dblclicked(event, ...args) {
    if (!filter6.apply(this, arguments))
      return;
    var t06 = this.__zoom, p02 = pointer_default(event.changedTouches ? event.changedTouches[0] : event, this), p1 = t06.invert(p02), k1 = t06.k * (event.shiftKey ? 0.5 : 2), t16 = constrain(translate(scale2(t06, k1), p02, p1), extent5.apply(this, args), translateExtent);
    noevent_default3(event);
    if (duration > 0)
      select_default2(this).transition().duration(duration).call(schedule, t16, p02, event);
    else
      select_default2(this).call(zoom.transform, t16, p02, event);
  }
  ...
  zoom.extent = function(_) {
    return arguments.length ? (extent5 = typeof _ === "function" ? _ : constant_default12([[+_[0][0], +_[0][1]], [+_[1][0], +_[1][1]]]), zoom) : extent5;
  };
