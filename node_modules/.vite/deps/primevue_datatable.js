import {
  script as script5
} from "./chunk-6HON4VXC.js";
import {
  script as script3,
  script2 as script4
} from "./chunk-4WI6B63S.js";
import {
  FilterMatchMode,
  FilterOperator,
  FilterService
...
function render18(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("svg", mergeProps({
    ...
    clipPath: "url(#".concat($options.pathId, ")")
  }, _hoisted_38, 8, _hoisted_117), createBaseVNode("defs", null, [createBaseVNode("clipPath", {
    id: "".concat($options.pathId)
...
var _hoisted_69 = [_hoisted_216, _hoisted_39, _hoisted_49, _hoisted_59];
var _hoisted_72 = ["id"];
...
function render19(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("svg", mergeProps({
    ...
    clipPath: "url(#".concat($options.pathId, ")")
  }, _hoisted_69, 8, _hoisted_118), createBaseVNode("defs", null, [createBaseVNode("clipPath", {
    id: "".concat($options.pathId)
    ...
    exportCSV: function exportCSV(options2, data15) {
      ...
      if (!data15) {
        ...
        if (options2 && options2.selectionOnly)
          ...
          data15 = data15 ? [].concat(_toConsumableArray3(this.frozenValue), _toConsumableArray3(data15)) : this.frozenValue;
      }
